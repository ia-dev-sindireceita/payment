...
- **Status:** **Proposto** — CEO **endossou o modelo (b)** em 2026-08-14 ([SIN-69274](/SIN/issues/SIN-69274), comment `e1e4d056`) com condições (i)–(iv). **Gate formal de impl:** interação board-only `5e458c95` no thread de SIN-69274 (só o board humano resolve). **Design (este ADR + plano) autorizado desde já; impl em HOLD até o board confirmar (b).**
